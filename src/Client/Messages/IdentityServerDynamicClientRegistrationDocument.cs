...
/// <summary>
/// Represents a dynamic client registration request made to IdentityServer. The
/// parameters that are supported include a subset of the parameters defined by
/// IANA
/// (https://www.iana.org/assignments/oauth-parameters/oauth-parameters.xhtml#client-metadata),
/// and custom properties needed by IdentityServer.
/// </summary>
public class IdentityServerDynamicClientRegistrationRequest
{
    /// <summary>
